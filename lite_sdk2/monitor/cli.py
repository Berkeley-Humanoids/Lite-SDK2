"""``lite-sdk2-monitor`` — subscribe to a Humanoid Control topic and print each sample.
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        ...
        description="Subscribe to a Humanoid Control topic and print decoded samples.",
    )
